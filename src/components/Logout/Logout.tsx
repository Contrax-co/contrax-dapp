      ...
      <div className={`logout__modal ${lightMode && 'logout__modal--light'}`}>
        <div className={`logout__info`}>
          ...
          <div className={`logout__icon`}>
            ...
            <p
              className={`logout__address ${
                lightMode && 'logout__address--light'
              }`}
            >
          ...
          <div
            className={`logout__arbiscan ${
              lightMode && 'logout__arbiscan--light'
            }`}
            onClick={() =>
              window.open(
          ...
          <div
            className={`logout__button ${lightMode && 'logout__button--light'}`}
            onClick={logout}
          >
            <p>Logout</p>
          </div>
