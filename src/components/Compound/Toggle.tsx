...
function Toggle({ lightMode, active, pool, ...props }: any) {
  return (
    <div className="switch">
      ...
      >
        <div
          className={`toggle_button ${lightMode && "toggle_button--light"} ${active && "toggle_button--selected"} ${
      ...
      <p
        className={`second_switch ${lightMode && "second_switch--light"} ${active && "second_switch--selected"} ${
