...
function Details({ lightMode, currentWallet, pool, ...props }: any) {
  ...
  return (
    <div>
      <div className={`details_top_container`}>
        <div className={`details_leftside`}>
          <div className={`details_dropdrown_header`}>
            ...
            {pool.pair2 ? (
              <p
                className={`details_pair_name ${
                  lightMode && 'details_pair_name--light'
                }`}
              >
          ...
          <div className={`token_details`}>
            {pool.alt1 ? (
              <div
                className={`details_single_token ${
                  lightMode && 'details_single_token--light'
                }`}
                style={{ marginRight: '10px' }}
              >
                <img
                  className={`mini_details_image`}
                  alt={pool.alt1}
                  src={pool.logo1}
                />
                <p>
        ...
        <div
          className={`detailed_position ${
            lightMode && 'detailed_position--light'
          }`}
        >
          <p
            className={`detailed_position_total ${
              lightMode && 'detailed_position_total--light'
            }`}
          >
            My Position
          </p>
      ...
      <div
        className={`details_retract ${lightMode && 'details_retract--light'}`}
        onClick={props.onClick}
      >
        <p
          className={`details_retract_description ${
            lightMode && 'details_retract_description--light'
          }`}
        >
          See Less
        </p>
