          ...
          <div className={`inside_toggle ${!currentWallet && "inside_toggle-none"}`}>
            ...
            <div className={`withdraw_tab2 ${!currentWallet && "withdraw_tab2-disable"}`}>
              <div className={`lp_withdraw_amount ${lightMode && "lp_withdraw_amount--light"}`}>
                ...
                {toggleType ? (
                  <p className={`withdraw_max ${lightMode && "withdraw_max--light"}`} onClick={withdrawMax}>
                    max
                  </p>
                ) : (
                  <p className={`withdraw_max ${lightMode && "withdraw_max--light"}`} onClick={withdrawEthMax}>
                    max
                  </p>
                )}
              </div>
              ...
              {toggleType ? (
                <div className={`withdraw_withdraw ${lightMode && "withdraw_withdraw--light"}`}>
                  {!withdrawAmt || withdrawAmt <= 0 ? (
                    <div
                      className={`withdraw_zap1_button_disable ${lightMode && "withdraw_zap1_button_disable--light"}`}
                    >
                      <p>Withdraw</p>
                    </div>
