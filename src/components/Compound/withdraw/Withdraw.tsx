              ...
              <div className={`inside_toggle ${!currentWallet && "inside_toggle-none"}`}>
                  ...
                  <div className={`withdraw_tab2 ${!currentWallet && "withdraw_tab2-disable"}`}>
                      <div className={`lp_withdraw_amount ${lightMode && "lp_withdraw_amount--light"}`}>
                          <input type="number" className={`lp_bal_input ${lightMode && "lp_bal_input--light"}`} placeholder="0.0" value={withdrawAmt} onChange={handleWithdrawChange} />
                          
                      </div>
                      {toggleType ? (
                          <div className={`zap_button ${lightMode && "zap_button--light"}`} 
                            onClick={() => 
                              withdraw(pool, withdrawAmt, setWithdrawAmt, setLoading, setLoaderMessage)
                            }
                          >
                              <p>Withdraw LP</p>
                          </div>
                          ...
                          <div className={`zap_button ${lightMode && "zap_button--light"}`} 
                          onClick={() => 
                            zapOut(setLoading, setLoaderMessage, pool, withdrawAmt, setWithdrawAmt)
                          }
                          >
                              <p>Withdraw ETH</p>
                          </div>
