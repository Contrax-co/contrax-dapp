 ...
 */
export const withdraw = async(setSuccess:any, setSecondaryMessage:any, gasPrice:any, pool:any, withdrawAmount:any, setWithdrawAmount:any, setLoading:any, setLoaderMessage:any) => {
    const {ethereum} = window;
    setSuccess("loading"); 
    setLoading(true);
