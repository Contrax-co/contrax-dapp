    ...
    <div className={`pools ${lightMode && "pools--light"}`}>
          ...
          <div className="pool_info">
            ...
            {totalVaultBalance * priceOfSingleToken < 0.01 ? (
              ...
              <div className={`container ${lightMode && "container--light"}`}>
                ...
                <p className={`tvlLP ${lightMode && "tvlLP--light"}`}>{totalVaultBalance.toFixed(10)}</p>
              </div>
            )}
            ...
            <div className={`container1 ${lightMode && "container1--light"}`}>
              {!pool.total_apy ? (
                <div className={`container1_apy ${lightMode && "container1_apy--light"}`}>
                  <p className={`pool_name ${lightMode && "pool_name--light"}`}>{apyVisionAPY.toFixed(2)}%</p>
      ...
      {dropdown === false ? null : (
        <div className={`dropdown_menu ${lightMode && "dropdown_menu--light"}`}>
          ...
          {buttonType === "Deposit" && (
            <Deposit lightMode={lightMode} pool={pool} currentWallet={currentWallet} connectWallet={connectWallet} />
          )}

          {buttonType === "Withdraw" && (
            <Withdraw lightMode={lightMode} pool={pool} currentWallet={currentWallet} connectWallet={connectWallet} />
          )}
