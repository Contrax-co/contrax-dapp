  ...
  return (
    <div className="addliquidity_outsidetab">
      {pool.token_type === "LP Token" ? (
        <Toggle lightMode={lightMode} active={toggleType} pool={pool} onClick={() => setToggleType(!toggleType)} />
      ) : null}

      <div className="addliquidity_descriptiontab">
        <div className={`addliquidity_description ${lightMode && "addliquidity_description--light"}`}>
          <p className={`addliquidity_description_title ${lightMode && "addliquidity_description_title--light"}`}>
            Description
          </p>
          ...
          {toggleType ? (
            <p className="description_description">
              ...
              pool. Your tokens wil be staked on {pool.platform} for fees and rewards. All rewards are sold to
            ...
            <p className="description_description">
              ...
              . Your ETH will be swapped for LP tokens to earn fees and rewards, which are sold to auto-compound your LP
              position. Note that "Max" leaves a small amount of ETH for gas. You'll need it to exit the farm later.
              <br />
              <br />
              After depositing, remember to confirm the transaction in your wallet.
            </p>
