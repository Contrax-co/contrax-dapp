...
Before doing this guide, follow the quick guide on [creating a Contrax wallet](../start/wallet-setup), unless you already have your own web3 wallet of choice.

Note that, if you already have a Web3 wallet, you do not need this guide. You should see your wallet when you click "Connect Wallet" and then "Wallet Connect."
