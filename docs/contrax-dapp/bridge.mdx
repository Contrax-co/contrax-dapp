---
title: "Bridge ETH from mainnet to Arbitrum"
description: "This page is only for users who can only move mainnet ETH to their wallet and need to bridge it manually to use the farms"
---
