...
Here you will see all your tokens that have vaults on Contrax. If you followed the transfer guides, you will just see ETH here
...
To get more details about your positions, see the actual vaults on the [Earn page](../contrax-dapp/farms).
