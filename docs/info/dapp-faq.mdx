...
Contrax is currently in its beta phase. Its live right now for you to [use right now](https://beta.contrax.finance). Currently all listed farms are tested. Our smart contracts have been penetration tested by the open source hacking community at Immunefi. We continue to offer a [bug bounty](https://immunefi.com/bounty/contrax/) for any critical vulnerabilities.
