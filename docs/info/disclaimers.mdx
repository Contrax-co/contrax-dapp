...
Contrax offers stablecoin liquidity pools, but if a stablecoin de-pegs from its asset, it can result in extreme loss due to price and impermanent loss risks. Research stablecoins and the risks of de-pegging before participating in any stablecoin farm.
...
Contrax is currently in beta and has not finalized our fee model. We collect 10% of the auto-compounded APY, which is a fraction of the total APY.
