...
MetaMask provides you with a 20 word "seed phrase" which is the actual password (or key) to your wallet. The phrase is not seen by Metamask or your browser. As long as you have this phrase and do not share it with anyone, only you have control over your tokens.
