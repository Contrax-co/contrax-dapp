...
To use metamask instead of Social logis:

1. Select MetaMask after "Connect Wallet," you will be prompted to download MetaMask for your browser.

2. Follow the process to set up the extention or download the app. Be sure to save your 12 recovery words in writing in a safe place to ensure you can always have access to your wallet.

3. Once installed, select "MetaaMask" when you click "Connect Wallet" in the same browser you have the exention installed. O

4. Once connected, switch the Netowrk from "Ethereum" to "Arbitrum One"

<img height="500" width="500" src="/images/Wallet/5.png" />

5. You are set! To copy your wallet address to recieve funds, just click the extention, and then click "Copy Address"

<img height="500" width="500" src="/images/Wallet/6.png" />

Also, with all tranasctions, you'll have to approve them from the wallet. It will either pop up or at least have a badge number show up to prompt you to approve the transactions.
