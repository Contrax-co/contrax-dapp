...
If select MetaMask after "Connect Wallet," you will be prompted to download MetaMask for your browser.

The process to set up the exetntion or download the app is straightforward. Be sure to save your 12 recovery words in writing in a safe place to ensure you can always have access to your wallet.

Once installed, you can select MetaaMask when you click "Connect Wallet." Once connected, you just have to be sure to switch the Netowrk from "Ethereum" to "Arbitrum One"
