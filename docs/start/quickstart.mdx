...
2. [Transferring it](../contrax-dapp/wallet-funding) from another site like Coinbase, Binance, Crypto.com, Kraken, or others. We have guides for each one.

## Select the farm you want to join

Contrax offers single token or dual token farms. You can read more about them in our [disclaimers page](../info/disclaimers).
...
2. Select the farm want. For example, the ETH farm.
...
If you need more details, see [the Farms docs page](../contrax-dapp/farms).
