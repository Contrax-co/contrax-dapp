...
To use any farm, all you need is a wallet with Arbitrum USDC or ETH. With Contrax, you can easily [set up a wallet](../start/wallet-setup) with just a social account like Google or Facebook.
...
You take your USDC or ETH and enter a new farm, withdraw it from the dashboard, or sell it back into your currency on the "buy" page.
