...
There are two types of farm: single-sided staking (GMX, USDC, and USDT) and LP staking (the rest). The single sided requires you to swap into the token, but for the LP farms, you can skip straight to depositing.
